...
## Overview
Sometimes we receive data samples with a small amount of data. This small amount might be affected by the periodicity of the observation. For example, daily observation will result in a larger set of data than annual observation.
